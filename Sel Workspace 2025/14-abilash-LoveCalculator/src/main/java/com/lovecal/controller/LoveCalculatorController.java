...
public class LoveCalculatorController {
	...
	public String calculate(LoveCalculatorDTO calculatorDto,Model model,HttpSession session,RedirectAttributes redirectAttribute) {
...
//		1. Get Yourname and crushname
		...
		redirectAttribute.addFlashAttribute("history",history);
