...
public interface LabtopDao extends JpaRepository<Labtop,Integer>{
	...
	@Query(value = "DELETE FROM labtop WHERE id=:id", nativeQuery = true)
	@Modifying
	@Transactional
	int deleteFromLabtop(int id);
	...
	@Modifying // provide transational mangagement obj
	@Transactional // Atomic - do or nothing
